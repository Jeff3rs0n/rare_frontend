  ...
  <Card css={{ p: "$6", mw: "100%" }}>
          <Card.Header>
            ...
            <Grid.Container css={{ pl: "$6" }}>
              ...
              <Grid xs={12}>
                <Text css={{ color: "$accents8", fontFamily: "monospace" }} size={12}>
          ...
          <Card.Body css={{ py: "$2" }}>
            ...
            <div>
              <Text css={{ color: "$accents8", fontFamily: "monospace" }}>
                ...
                The CORE DAO Network inspired the Creation of RareBay, Not just an
                NFT Marketplace, but a truely dencetralized way of interacting
                with these NFTs. RareBay is RARE.
              </Text>
            </div>
          </Card.Body>
          <Card.Footer>
          ...
          <Card.Body css={{ py: "$2" }}>
            ...
            <div>
              ...
              Rarity is directly proportional to price and is a method of determing how less likely you can find
                something. This technique is used by other marketplaces 
                 shallowlly based as how many owners and price of the NFT.
                Rarity determined from number of owners and the price of NFT can
                change based on the owners wishes, RareBay Marketplace uses a
                more robust manner of determing the Rarity of an NFT.
              </Text>
              <Spacer />
              <Text h4 css={{ color: "$accents8", fontFamily: "monospace" }}>
                Working Mechanism
              ...
              <Text css={{ color: "$accents8", fontFamily: "monospace" }}>
                ...
                amounts to 1 $RARE token if never unstaked. The Supply of the $RARE
                ...
                of these 1000 ERC20 buy a user is free and only liable to gas
                fees. A creator has the option of unstaking at there on free
                will without the need to pay staking or unstaking Fees with only
                one requirement. $RARE Token rewarded from
                staking can be used to buy and sell ERC20 NFT on RareBay at
                discounted prices.
              </Text>
              <Spacer />
              <Text h4 css={{ color: "$accents8", fontFamily: "monospace" }}>
                ...
                <Text css={{ color: "$accents8", fontFamily: "monospace" }}>
                  ...
                  unacceptable content in a decentralized DAO Voting. Once verified, John's
                  Listing is published on the markeplace for other users to buy.
                  The Rarity of John's collection will default to Zero. He
                  Can decide to list these items at his price of choice as either
                  an Auction or a direct listing. John wants to stake in this
                  scenario. Staking his 1000 items will earn him an equivalent
                  of 1 $RARE token per year if he never unstakes. Staking Increase
                  rarity in a value propotional to the Tokens being earned.
                  ...
                  the 1000 items that made this possible will have increased
          ...
          <Card.Body css={{ py: "$2" }}>
            ...
            <div>
              <Text css={{ color: "$accents8", fontFamily: "monospace" }}>
                ...
                earn this Token per every 1000 NFT staked.
              </Text>
            </div>
          </Card.Body>
          <Card.Footer>
          ...
          <Card.Body css={{ py: "$2" }}>
            ...
            <div>
              <Text css={{ color: "$accents8", fontFamily: "monospace" }}>
                ...
                On Launch, creators can start Rarity Increament of their NFT
                upon successful staking. Staking has no other fees other than gas
                fees, $RARE Token has an unlimited supply and no direct admin.
                $RARE Token can only be claimed from this form of staking. The
                only distribution done is 100% earned from staked NFTs. Rarity
                will still not determine the price value of an item but I bet
                anybody would want to sell less than than it costs them staking
                time. Users can decide to sell items with or without Rarity but
                buyers can decide only to buy items with highest Rarity that is
                not affected by number of owners or the creator's biased price
                but rather affected by time, just like whiskey barrels.
              </Text>
            </div>
          </Card.Body>
          <Card.Footer>
